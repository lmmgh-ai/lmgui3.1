...
local events_system = require("events_system")
local API = require("API")
local color = require("libs.love2D_libs.Color.Color")
--管理器
--默认 帧布局
local gui = {
    x = 0,
...
function gui:init()
    ...
    --初始化字体系统
    self.font_manger = require("font_manger")
...
function gui:load_layout(lay)
    ...
    for child, parent in pairs(relations) do
        ...
        if parent == 0 then
            ...
            view_lay.type = view_lay.type or "line_layout"
